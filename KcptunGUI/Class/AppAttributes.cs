...
namespace KcptunGUI.Class {
    class AppAttributes {
        ...
        public static readonly String ResxPath = Path.Combine(FilePath ,"Resx");//资源目录,D:\My Projects\KcptunGUI\KcptunGUI\bin\Debug\x86\Resx
        public static readonly String ConfigFilePath = Path.Combine(FilePath,"config.json");//配置文件,D:\My Projects\KcptunGUI\KcptunGUI\bin\Debug\x86\config.json
