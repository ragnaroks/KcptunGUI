        ...
        {//输入框变动事件
            ...
            switch (thisTextBox.Name)
            {
                ...
                case "KcptunConfig_LocalPort":
                    ...
                    if (thisTextBox.Text.Length >= 5) { thisTextBox.Text = thisTextBox.Text.Substring(0, 5); }
                ...
                case "KcptunConfig_Connects":
                    thisTextBox.Text = KcptunConfig_LocalPort_Regex.Replace(thisTextBox.Text, "");
                    if (thisTextBox.Text.Length >= 3) { thisTextBox.Text = thisTextBox.Text.Substring(0, 3); }
                    thisTextBox.SelectionStart = thisTextBox.Text.Length;
                ...
                case "KcptunConfig_DSCP":
                    thisTextBox.Text = KcptunConfig_LocalPort_Regex.Replace(thisTextBox.Text, "");
                    if (thisTextBox.Text.Length > 2) { thisTextBox.Text = thisTextBox.Text.Substring(0, 2); }
                    thisTextBox.SelectionStart = thisTextBox.Text.Length;
                ...
                case "KcptunConfig_MTU":
                    thisTextBox.Text = KcptunConfig_LocalPort_Regex.Replace(thisTextBox.Text, "");
                    if (thisTextBox.Text.Length > 4) { thisTextBox.Text = thisTextBox.Text.Substring(0, 4); }
                    thisTextBox.SelectionStart = thisTextBox.Text.Length;
                ...
                case "KcptunConfig_ReSend":
                    thisTextBox.Text = KcptunConfig_LocalPort_Regex.Replace(thisTextBox.Text, "");
                    if (thisTextBox.Text.Length > 1) { thisTextBox.Text = thisTextBox.Text.Substring(0, 1); }
                    thisTextBox.SelectionStart = thisTextBox.Text.Length;
                    if (thisTextBox.Text.Length > 0)
                    {
